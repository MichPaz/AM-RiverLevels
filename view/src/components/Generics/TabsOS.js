                        ...
                        {config.navButtons &&
                            <Grid container justify='space-around'>
                                ...
                                {(show === tabs.length - 1 && config.onSubmit) &&
                                    <Button style={config.item.action != 2 ? { display: 'none' } : { display: '' }} onClick={finishOS} variant="contained" color="secondary">
                                        Finalizar
                                    </Button>}

                                {(show === tabs.length - 1 && config.onSubmit) &&

                                    <Button onClick={config.onSubmit} color='primary' variant="contained">
                                        {config.item.statusAtual == 0 ? 'INICIAR' : config.item.statusAtual == 1 ? 'PAUSAR' : 'INICIAR'}
                                    </Button>
